...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'crze5@6g4c51.onmicrosoft.com',
  ...
  footer:
    'Powered by <a href="https://" target="_blank" rel="noopener noreferrer">cz</a>. Made with ❤ by Chandresh.',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: ['/📽️ Bollywood Movies', '/🍿 Web Series', '/🧑🏻‍💻 CRZ Cloud', '/🎭 Gujarati Movies', '/🌎 Hollywood Movies', '/🔋 South Movies'],
